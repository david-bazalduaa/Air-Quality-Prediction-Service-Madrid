...
def backfill_predictions_for_monitoring(weather_fg, air_quality_df, monitor_fg, model):
    ...
    features_df['predicted_pm25'] = model.predict(features_df[['temperature_2m_mean', 'precipitation_sum', 'wind_speed_10m_max', 'wind_direction_10m_dominant','cloud_cover_max', 'relative_humidity_2m_mean', 'dew_point_2m_max']])
